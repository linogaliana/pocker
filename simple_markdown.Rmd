...
This `markdown` is used to test if `Python` works in `Docker` repository. It is also the occasion to compare `Rcpp`, `Python` and `R` speed on the same program. We use, in three cases, loops even if we know it is inefficient
